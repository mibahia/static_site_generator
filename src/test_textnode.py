...
class TestTextNode(unittest.TestCase):
    ...
    def test_split_nodes_delimiter_node(self):
        ...
        expected_output1 = [TextNode("This is a text with a ", TextType.TEXT), TextNode("bold block", TextType.BOLD), TextNode(" word", TextType.TEXT)]
        ...
        expected_output2 = [TextNode("This is a test with a ", TextType.TEXT), TextNode("bold block", TextType.BOLD), TextNode(" word", TextType.TEXT), TextNode("This is a text with a ", TextType.TEXT), TextNode("bold", TextType.BOLD), TextNode(" word", TextType.TEXT)]
    ...
    def test_split_nodes_links_and_images(self):
        ...
        image_node = TextNode("This is text with a ![rick roll](https://i.imgur.com/aKaOqIh.gif) and ![obi wan](https://i.imgur.com/fJRm4Vk.jpeg)", TextType.IMAGE)
        link_node = TextNode("Look at this link [to dev](https://www.dev) and [to guardian](https://www.guardian.com)", TextType.TEXT)

        output_link = split_nodes_link([link_node, text_node])
        output_image = split_nodes_image([image_node])

        expected_output_image = [TextNode("This is text with a ", TextType.TEXT, None), TextNode("rick roll", TextType.IMAGE, "https://i.imgur.com/aKaOqIh.gif"), TextNode(" and ", TextType.TEXT, None), TextNode("obi wan", TextType.IMAGE, "https://i.imgur.com/fJRm4Vk.jpeg")]
        expected_output_link = [TextNode("Look at this link ", TextType.TEXT, None), TextNode("to dev", TextType.LINK, "https://www.dev"), TextNode(" and ", TextType.TEXT, None), TextNode("to guardian", TextType.LINK, "https://www.guardian.com"), TextNode("Text node", TextType.TEXT, None)]
